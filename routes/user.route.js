...
var transporter = nodemailer.createTransport({
    service: 'gmail',
    auth: {
        user: 'dalimagh0@gmail.com',
        pass: 'hvfz pwmo dhtx ckoy'
    },
    tls: {
...
//edit status active or disabled
...
router.post('/register', async (req, res) => {
    try {
        ...
        //send verif mail to change status
        var mailOption = {
            from: '"verify your email " <dalimagh0@gmail.com>',
            to: newUser.email,
